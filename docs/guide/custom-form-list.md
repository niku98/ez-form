...
`AntFormList` will be same as `AntFormItem`, in [Custom FormItem](/guide/custom-form-item), we have done full description for each parts. So, in this article, we will have some short description and narrow them to article [Custom FormItem](/guide/custom-form-item).

### **Basic:**

Just like `AntFormItem`, **EzForm** also provide `useFormListComponentLogics`, to handle all form list component logics.

**See also:** [Custom FormItem - Basic](/guide/custom-form-item#basic)

### Show Error

You can read about this in [Custom FormItem - Show Error](/guide/custom-form-item#show-error).

### Ant Design Style

Everything you need to know is described in this article: [Custom FormItem - Ant Design Style ](/guide/custom-form-item#ant-design-style).
